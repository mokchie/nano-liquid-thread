...
This reads the data generated by lammps and plots the profile evolution of the liquid thread.

    python plotspectrum.py

This reads the data generated by lammps and computes the spectrum and plots the spectrum curves.

    python plothmax.py

This reads the data generated by lammps and plots the evolution of the maximum perturbation magnitude.

    python plot2H1.py

This reads the data generated by lammps and plots the evolution of the first-order Fourier coefficient.

After the post-processing by plotspectrum.py, plothmax.py and plot2H2.py, the processed data will be stored in files of npy format, they can be further read and compared with analytic results.
